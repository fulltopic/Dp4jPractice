...
class FPWoAcceptWhPlayer(fileName: String) {
  private val logger = Logger("FPWoAcceptPlayer")
  
//  var trans = scala.collection.immutable.Vector.empty[Transition[Integer]]
  var playerTrans = Array.fill[ArrayBuffer[Transition[Integer]]](PlayerNum) (ArrayBuffer[Transition[Integer]]())
  ...
  private def createTransition(index: Int, state: Array[Int], nextState: Array[Int], action: Int, reward: Int, gameOver: Boolean): Unit = {
  ...
  def parseDrop(node: Node, index: Int): Unit = {
    ...
    createTransition(index, origState, currentStats(index), tile / NumPerTile, DefaultReward, false)
  }
  ...
  def parseMinkan(index: Int, m: Int): Unit = {
    ...
    createTransition(index, state, currentStats(index), MinKanWoAccept, DefaultReward, false)
  }
  ...
  def parseAnkan(index: Int, m: Int): Unit = {
    ...
    createTransition(index, origState, currentStats(index), AnKanWoAccept, DefaultReward, false)
  }
  ...
  def parseKakan(index: Int, m: Int): Unit = {
    ...
    createTransition(index, origState, currentStats(index), KaKanWoAccept, DefaultReward, false)
  }
  ...
  def parsePong(index: Int, m: Int): Unit = {
    ...
    createTransition(index, origState, currentStats(index), PongWoAccept, DefaultReward, false)
  }
  ...
  def parseChow(index: Int, m: Int): Unit = {
    ...
    createTransition(index, origState, currentStats(index), ChowWoAccept, DefaultReward, false)
  }
  ...
  def parseTerminal(node: Node): Unit = {
    ...
    for (i <- rewards.indices) {
      if (i == who) {
        ...
        createTransition(i, state, currentStats(i), RonWoAccept, rewards(i), true)
      }else {
        createTransition(i, currentStats(i), currentStats(i), NOOPWoAccept, rewards(i), true)
      }
    }
  }
  ...
  def parseReach(node: Node): Unit = {
    ...
    step match {
      case 1 =>
        ...
        createTransition(who, origState, currentStats(who), REACHWoAccept, ReachReward, false)
