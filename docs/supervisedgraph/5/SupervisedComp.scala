...
import rl.dqn.reinforcement.dqn.nn.datapocess.{TenhouCompCnnLstmIterator, TenhouLstmIterator, TenhouXmlCnnFetcher}
...
//    confB.inputPreProcessor("densepre", new TenhouInputPreProcessor())
  ...
  def train(): Unit = {
    ...
    val trainIte = new TenhouCompCnnLstmIterator(trainPath, batchSize, true)
    val validIte = new TenhouCompCnnLstmIterator(validPath, batchSize, true)
...
//      Nd4j.getWorkspaceManager.destroyAllWorkspacesForCurrentThread()
  ...
  def test(): Unit = {
    ...
    val testIte = new TenhouCompCnnLstmIterator(testPath, batchSize, true)

    val modelPath = "/home/zf/workspaces/workspace_java/mjpratice/docs/supervisedgraph/1/nnmodel_1536109296444.xml"
